...
//       // Check Firestore if user has seller role
...
//       const userData = userSnap.data(); //fetch user data

//       if (userData.role !== 'seller') {
//         setError('You are not registered as a seller. Please use the buyer login page.');
//         setLoading(false);
//         return;
//       }
// onAuthStateChanged(auth, (firebaseUser) => {
//   if (firebaseUser) {
//     console.log(firebaseUser.uid); // must exist here
//   }
// });
...
//       setUser({
//         uid: user.uid, 
//         name: userData.name || user.displayName || 'Seller',
//         email: user.email || '',
//         role: 'seller',
...
//                   <div className="text-3xl font-bold text-primary-600">Giftly.seller</div>
//                 </Link>
...
//             <div className="lg:w-2/5 bg-gradient-to-br from-green-50 to-green-100 flex items-center justify-center p-8 lg:p-12">
//               <div className="text-center">
//                 <img
//                   src="https://user-gen-media-assets.s3.amazonaws.com/gpt4o_images/dd2e7151-dd51-4a34-a776-0114f940b962.png"
//                   alt="Person unlocking shop with key"
//                   className="w-80 h-80 object-contain mx-auto mb-6"
//                 />
//                 <h3 className="text-xl font-semibold text-gray-800 mb-2">Access Your Store</h3>
//                 <p className="text-gray-600">Unlock your business potential and manage your shop</p>
//                                 {/* Additional Info */}
//                 <div className="bg-green-50 border border-green-200 rounded-md p-4 mt-6">
//                   <h4 className="text-sm font-medium text-green-800 mb-2">🔐 Secure Seller Access</h4>
//                   <ul className="text-sm text-green-700 space-y-1 list-disc list-inside text-left">
        ...
        <div className="bg-white rounded-2xl shadow-xl overflow-hidden">
          <div className="flex flex-col lg:flex-row">
            ...
            <div className="lg:w-2/5 bg-gradient-to-br from-green-50 to-green-100 flex items-center justify-center p-8 lg:p-12">
              <div className="text-center">
                <img
                  src="https://user-gen-media-assets.s3.amazonaws.com/gpt4o_images/69a2c199-e1ac-4dee-9175-2e9bb9377fdb.png"
                  alt="Seller managing products"
                  className="w-80 h-80 object-contain mx-auto mb-6"
                />
                <h3 className="text-xl font-semibold text-gray-800 mb-2">Grow Your Store</h3>
                <p className="text-gray-600">Manage your products, orders, and track your sales easily</p>
                {/* Additional Info */}
                <div className="bg-green-50 border border-green-200 rounded-md p-4 mt-6">
                  <h4 className="text-sm font-medium text-green-800 mb-2">🔐 Secure Seller Access</h4>
                  <ul className="text-sm text-green-700 space-y-1 list-disc list-inside text-left">
                    ...
                    <li>Update store profile and branding</li>
                    <li>Analyze sales and customer data</li>
                  </ul>
                </div>
              </div>
            </div>
